  ...
  describe "PATCH #update" do
    ...
    context "with valid attributes" do
      it "assigns requested question to @question" do
        patch :update, params: { id: question, user: user, question: attributes_for(:question) }

        expect(assigns(:question)).to eq question
      end

      it "changes question attributes" do
        patch :update, params: { id: question, user: user, question: { title: "new title", body: "new body" } }
        question.reload
    ...
    context "with invalid attributes" do
      before { patch :update, params: { id: question, user: user, question: attributes_for(:question, :invalid) } }
